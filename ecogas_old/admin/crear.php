...
<head>
		...
		<body>
        <form method="post" id="content" target="_self" action="newregister.php">
        <table width="100%" border="0" cellspacing="10" cellpadding="0">
                <tr>
                    ...
                    <td width="86%" align="center" valign="middle">
                        <h1>Creación de una nueva zona tarifaria</h1>
                    </td> 				
                </tr>
          </table>
            <hr />
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="10">
              ...
              <tr>
                <td>Código:</td>
                <td><input class="ValCaplet input" type="text" id="codigo" name="codigo" value="<?php echo $codigo;?>"/></td>
                <td>Cargo fijo:</td>
                <td><input class="ValCaplet input" type="number" id="cargoFijo" name="cargoFijo" value="<?php echo $cargoFijo;?>"/></td>
                <td>Fact Minima:</td>
                <td><input class="ValCaplet input" type="number" id="factMinima" name="factMinima" value="<?php echo $factMinima;?>"/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td>Cuadro:</td>
                <td><input class="ValCaplet input" type="text" id="cuadro" name="cuadro" value="<?php echo $cuadro;?>"/></td>
                <td>Focegas</td>
                <td><input class="ValCaplet input" type="number" id="Focegas" name="Focegas" value="<?php echo $Focegas;?>"/></td>
                <td>Cargo m3 1000 a 9000</td>
                <td><input class="ValCaplet input" type="number" id="cargo1a9" name="cargo1a9" value="<?php echo $cargo1a9;?>"/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td>Cargo m3</td>
                <td><input class="ValCaplet input" type="number" id="cargom3" name="cargom3" value="<?php echo $cargom3;?>" /></td>
                <td>Cargo m3 &gt; 9000</td>
                <td><input class="ValCaplet input" type="number" id="cargo9" name="cargo9" value="<?php echo $cargo9;?>" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
